...
| **Image Creator** | `image-creator` | Gera imagens e ilustracoes | `tools/media/generate_images_leonardo.py`, Unsplash fallback |
...
- tools/media/generate_images_leonardo.py — geracao de imagens AI
...
3. Execute python tools/media/generate_images_leonardo.py com os parametros adequados
...
Para carrosseis: siga o workflow em workflows/marketing/producao/carrosseis/carrossel_case_projeto.md (Fase 2-3)
Para noticias ESG: siga workflows/marketing/producao/carrosseis/carrossel_noticias.md (busca Perplexity + geracao)
```
...
1. ADAPTAR ARTE (Illustrator):
   ...
   - Tool: tools/adobe/adapt_artwork_illustrator.py + tools/adobe/jsx/adapt_artwork.jsx
...
2. VETORIZAR IMAGEM (Illustrator Image Trace):
   ...
   - Tool: tools/media/vectorize_image_illustrator.py + tools/adobe/jsx/vectorize_image.jsx
...
3. MOTION GRAPHICS (After Effects):
   ...
   - Tool: tools/adobe/adapt_motion_aftereffects.py + tools/adobe/jsx/adapt_motion.jsx
...
Quando o Time de Midias Sociais (`workflows/marketing/referencia/team_midias_sociais.md`) precisa dos assets:
